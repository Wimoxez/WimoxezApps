...
<head>
    ...
    <link rel="shortcut icon" href="fainans/favicon.png">
    
    <!-- Bootstrap 3.3.2 -->
    <link rel="stylesheet" href="fainans/css/bootstrap.min.css">
    
    <link rel="stylesheet" href="fainans/css/animate.css">
    <link rel="stylesheet" href="fainans/css/font-awesome.min.css">
    <link rel="stylesheet" href="fainans/css/slick.css">
    <link rel="stylesheet" href="fainans/js/rs-plugin/css/settings.css">

    <link rel="stylesheet" href="fainans/css/styles.css">


    <script type="text/javascript" src="fainans/js/modernizr.custom.32033.js"></script>
...
<body>
    ...
    <div class="pre-loader">
        <div class="load-con">
            <img src="fainans/img/fainanslogo.png" class="animated fadeInDown" alt="">
            <div class="spinner">
            ...
            <div class="tp-banner" >
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        <!-- MAIN IMAGE -->
                        <img src="fainans/img/transparent.png"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption lfl fadeout hidden-xs"
                            ...
                            <img src="fainans/img/freeze/Slides/hand-freeze.png" alt="">
                        </div>
                        ...
                        <div class="tp-caption lfl fadeout visible-xs"
                            ...
                            data-start="700"
                            data-easing="Power4.easeOut">
                            <img src="fainans/img/freeze/iphone-freeze.png" alt="">
                        </div>
                    ...
                    <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        <div class="tp-caption lfb fadeout hidden-xs"
                            ...
                            data-start="700"
                            data-easing="Power4.easeOut">
                            <img src="fainans/img/freeze/Slides/freeze-slide2.png" alt="">
                        </div>
                    ...
                    <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                            ...
                            data-start="700"
                            data-easing="Power4.easeOut">
                            <img src="fainans/img/freeze/Slides/family-freeze.png" alt="">
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4" >
                        <img src="fainans/img/freeze/iphone-freeze.png" class="img-responsive scrollpoint sp-effect5" alt="">
                    </div>
        ...
        <section id="screens">
            <div class="container">
                ...
                <div class="slider filtering scrollpoint sp-effect5" >
                    <div class="one">
                        <img src="fainans/img/freeze/screens/profile.jpg" alt="">
                        <h4>Profile Page</h4>
                    </div>
                    <div class="two">
                        <img src="fainans/img/freeze/screens/menu.jpg" alt="">
                        <h4>Toggel Menu</h4>
                    </div>
                    <div class="three">
                        <img src="fainans/img/freeze/screens/weather.jpg" alt="">
                        <h4>Weather Forcast</h4>
                    </div>
                    <div class="one">
                        <img src="fainans/img/freeze/screens/signup.jpg" alt="">
                        <h4>Sign Up</h4>
                    </div>
                    <div class="one">
                        <img src="fainans/img/freeze/screens/calendar.jpg" alt="">
                        <h4>Event Calendar</h4>
                    </div>
                    <div class="two">
                        <img src="fainans/img/freeze/screens/options.jpg" alt="">
                        <h4>Some Options</h4>
                    </div>
                    <div class="three">
                        <img src="fainans/img/freeze/screens/sales.jpg" alt="">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="hanging-phone scrollpoint sp-effect2 hidden-xs">
                            <img src="fainans/img/freeze/freeze-angled2.png" alt="">
                        </div>
                        <div class="platforms">
        ...
        <footer>
            <div class="container">
                <a href="#" class="scrollpoint sp-effect3">
                    <img src="fainans/img/freeze/logo.png" alt="" class="logo">
                </a>
                <div class="social">
    ...
    <script src="fainans/js/jquery-1.11.1.min.js"></script>
    <script src="fainans/js/bootstrap.min.js"></script>
    <script src="fainans/js/slick.min.js"></script>
    <script src="fainans/js/placeholdem.min.js"></script>
    <script src="fainans/js/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
    <script src="fainans/js/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
    <script src="fainans/js/waypoints.min.js"></script>
    <script src="fainans/js/scripts.js"></script>
    <script>
